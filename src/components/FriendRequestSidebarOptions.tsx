...
export const iconWrapperClasses =
  'text-gray-400 border-gray-200 group-hover:border-primary-600 group-hover:text-primary-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white';
...
export default function FriendRequestSidebarOptions({
  ...
  return (
    <Link
      ...
      className="text-gray-700 hover:text-primary-600 hover:bg-gray-50 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
    >
